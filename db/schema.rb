...
ActiveRecord::Schema.define(version: 20160520151341) do
  ...
  create_table "associated_products_products", force: :cascade do |t|
  ...
  add_index "associated_products_products", ["associated_product_id"], name: "index_associated_products_products_on_associated_product_id", using: :btree
  add_index "associated_products_products", ["product_id"], name: "index_associated_products_products_on_product_id", using: :btree
  ...
  add_foreign_key "associated_products_products", "products"
